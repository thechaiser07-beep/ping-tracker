...
## Step 3 — Create the 5 Tables

You'll set up 5 tables. Airtable starts you with one called "Table 1" — rename and build from there.
...
Add another table, name it **`Mood`**, then add:
